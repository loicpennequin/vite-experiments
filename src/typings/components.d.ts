...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    Header: typeof import('../components/header/app-header.vue')['default'];
    ...
    Image: typeof import('../components/image/lazy-image.vue')['default'];
    ...
    Surface: typeof import('../components/content-surface.vue')['default'];
  }
}
